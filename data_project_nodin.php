            ...
            <ul class="navbar-nav" style="font-size:12px;">
				...
				-->
                    ...
                    <li class="nav-item" style="font-size:12px;">
                        <a class="nav-link text-white" href="index.php?link=data_inventory">
                            DATA PROJECT
                        </a>
                    </li>
                <?php
                ...
                ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="index.php?link=form_inventory">
                            ADD PROJECT
                        </a>
                    </li>
                    ...
                    <li class="nav-item ">
                        ...
                        if (!empty($_SESSION['level_pro']) && $_SESSION['level_pro'] <= "2") {
                            echo "<a class='nav-link text-white' href='index.php?link=rekap_inventory'>REKAP PROJECT</a>";
                        }
                ...
                <li class="nav-item ">
                    ...
                    if (!empty($_SESSION['level_pro']) && $_SESSION['level_pro'] == "1") {
                        ...
                        echo "<a class='nav-link text-white' href='index.php?link=import_inventory'>IMPORT DATA</a>";
                    }
                    ?>
                </li>
            </ul>
    ...
    <div id="konten" class="bg-info" style="height:89%;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <?php
                include 'koneksi.php';
                $des_inventory_imes = mysqli_query($con, "select COUNT(*) as total from tb_inventory_imes where divisi_bud='DES'");
                $des_inventory_imes = mysqli_fetch_assoc($des_inventory_imes);
                // var_dump($des_inventory_imes['total']);
                ?>

                <!-- Earnings (Monthly) Card Example -->
                <a href="index.php?link=data_inventory_des" style="text-decoration: none;">
                ...
                <?php
                include 'koneksi.php';
                $dgs_inventory_imes = mysqli_query($con, "select COUNT(*) as total from tb_inventory_imes where divisi_bud='DGS'");
                $dgs_inventory_imes = mysqli_fetch_assoc($dgs_inventory_imes);
                // var_dump($dgs_inventory_imes['total']);
                ?>
                <a href="index.php?link=data_inventory_dgs" style="text-decoration: none;">
                    <button class="col-sm col-md-4 mb-4">
                ...
                <?php
                include 'koneksi.php';
                $dbs_inventory_imes = mysqli_query($con, "select COUNT(*) as total from tb_inventory_imes where divisi_bud='DBS'");
                $dbs_inventory_imes = mysqli_fetch_assoc($dbs_inventory_imes);
                // var_dump($dgs_inventory_imes['total']);
                ?>
                <a href="index.php?link=data_inventory_dbs" style="text-decoration: none;">
                    <button class="col-sm col-md-4 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
