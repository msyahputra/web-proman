    ...
    <div id="konten" class="bg-info" style="height:89%;">
        <div id="tabel_warp" class="text-white">
            <table id="tb_proman" class="table table-striped table-bordered">
                ...
                <?php
                $pic_assurance = $_GET['pic_assurance'];

                $query_inventory_imes = mysqli_query($con, "select * from tb_inventory_imes where pic_assurance='$pic_assurance' order by no desc");
