...
if($_POST)
{
	...
	include("modul/action/import_act.php");
}
?>
...
<div class="card container p-0" style="border:none;width:800px;margin-top:15px;">
	...
	<div class="card-body text-center">
		<form name="import_form" action="index.php?link=import_inventory" method="POST" enctype="multipart/form-data">
		...
		<a href="doc_file/format/inventory_import.xls">Download File Format Here!</a>
	</div>
