...
if(!empty($_GET['action_clue']))
{
  $act = $_GET['action_clue'];
}
else
{
  $act = "input";
...
?>
    <div id="contain_user_form" class="mt-3 mb-2">
      ...
      <div class="card container p-0" style="width: 850px;border:none">
        ...
        <div class="card-body">
          <form class="container" style="width:800px" action="index.php?link=daftar_user&clue=<?php echo $act;?>" method="POST">
            ...
            <div class="clearfix mb-2">
              ...
              <div class="float-left col-7">
                <input type="password" name="rpassword" class="form form-control" value="">
              </div>
              <div class="float-left">
                <?php
                if(!empty($error['rpassword']))
                {
