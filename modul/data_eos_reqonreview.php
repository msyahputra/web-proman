<div id="tabel_warp" class="text-white">
    <table id="tb_proman" class="table table-striped table-bordered">
        ...
        <?php
        $query_inventory_imes = mysqli_query($con, "select * from tb_pemenuhan_eos where status_permintaan='Request on review' order by id desc");
        ...
        ?>
            <tbody style="background-color:#ffffff">
                ...
                while ($data_inventory = mysqli_fetch_array($query_inventory_imes)) {
                    ...
                    echo "<td><a href='index.php?link=detail_pemenuhan_eos&dt_proman=" . $data_inventory['id_pemenuhaneos'] . "'>" . $data_inventory['no_nodin'] . "</a></td>";
