...
if($act == "input_file")
{
	$update_info = $_POST['update_progress'];
	...
	if($query_update)
	{
		...
		if($query_proman)
		{
			...
			<script type="text/javascript">
				...
				document.location="index.php?link=detail_problem&dt_proman=<?php echo $id_problem;?>";
			</script>
			<?php
		}
		else
...
if($act == "delete_file")
{
	...
	else
	{
		...
		<script type="text/javascript">
			...
			document.location="index.php?link=detail_problem&id_problem=<?php echo $id_problem; ?>";
		</script>
		<?php
	}
}
